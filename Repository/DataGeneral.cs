...
namespace Repository
{
    public class DataGeneral
    {
        ...
        {
            return SqlHelper.ExecuteDataset(strConnection, "Formulacion.spp_help_msto_Proyecto_CentroCosto", strCodCentroGestor, intDigito,strCodEmpleado);
        }
        ...
        {
            DataSet ds = new DataSet();
            ds = SqlHelper.ExecuteDataset(strConnection, "General.spp_cbo_ctrl_TipoMoneda");
            return ds;
        }
        #endregion
