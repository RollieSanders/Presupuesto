...
{
    public partial class Frm_ConsultaSaldos_Proyecto_Formulado : DevExpress.XtraEditors.XtraForm
    {
        

        private SRgestion.WCFgestionEClient objWCF = new SRgestion.WCFgestionEClient();

        public Frm_ConsultaSaldos_Proyecto_Formulado()
        {
            InitializeComponent();
        }
                          ...
                          )
        {
            ...
            {
                DT_Formulacion = objWCF.Lista_Formulado_Proyecto( strAñoProceso,
                                                        strCodProyecto,
                                                        strCodClasificador
                                                     ).Tables[0];
            }
            else
            {
                ...
                DT_Formulacion = SRD.Lista_Formulado_Proyecto(strAñoProceso,
                                                        strCodProyecto,
                                                        strCodClasificador
                                                     ).Tables[0];
            }
