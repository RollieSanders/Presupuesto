...
{
    public partial class Frm_ConsultaSaldos_CentroCosto_Comprometidos : DevExpress.XtraEditors.XtraForm
    {
       
        private SRgestion.WCFgestionEClient objWCF = new SRgestion.WCFgestionEClient();

        public Frm_ConsultaSaldos_CentroCosto_Comprometidos()
        {
            InitializeComponent();
        }
                          ...
                          )
        {
            ...
            {
                DT_Requerimiento = objWCF.Lista_Comprometido_CentroCosto(   strAñoProceso,
            ...
            else
            {
                ...
                DT_Requerimiento = SF.Lista_Comprometido_CentroCosto(strAñoProceso,
                                                                            strCodcentroCosto_Gestor,
                                                                            strCodCentroCosto,
                                                                            strCodClasificador
                                                                            ).Tables[0];
