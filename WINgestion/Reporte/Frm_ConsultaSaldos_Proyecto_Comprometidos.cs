...
{
    public partial class Frm_ConsultaSaldos_Proyecto_Comprometidos : DevExpress.XtraEditors.XtraForm
    {
       
        private SRgestion.WCFgestionEClient objWCF = new SRgestion.WCFgestionEClient();

        public Frm_ConsultaSaldos_Proyecto_Comprometidos()
        {
            InitializeComponent();
        }
                          ...
                          )
        {
            ...
            {
                DT_Requerimiento = objWCF.Lista_Comprometido_Proyecto(   strAñoProceso,
                                                                            strCodProyecto,
                                                                            strCodClasificador
                                                                                ).Tables[0];
            }
            else
            {
                ...
                DT_Requerimiento = SF.Lista_Comprometido_Proyecto(strAñoProceso,
                                                                            strCodProyecto,
                                                                            strCodClasificador
                                                                            ).Tables[0];
            }
