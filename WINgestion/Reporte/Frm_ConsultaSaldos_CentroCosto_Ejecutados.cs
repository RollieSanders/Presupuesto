...
{
    public partial class Frm_ConsultaSaldos_CentroCosto_Ejecutados : DevExpress.XtraEditors.XtraForm
    {

        private SRgestion.WCFgestionEClient objWCF = new SRgestion.WCFgestionEClient();

        public Frm_ConsultaSaldos_CentroCosto_Ejecutados()
        {
            InitializeComponent();
        }
        ...
        public void ShowMe(string strAñoProceso,
                            ...
                            )
            {
                ...
                {
                    DT_Requerimiento = objWCF.Lista_Ejecutado_CentroCosto(strAñoProceso,
                ...
                else
                {
                    ...
                    DT_Requerimiento = SF.Lista_Ejecutado_CentroCosto(strAñoProceso,
                                                                                strCodcentroCosto_Gestor,
                                                                                strCodCentroCosto,
                                                                                strCodClasificador
                                                                                ).Tables[0];
