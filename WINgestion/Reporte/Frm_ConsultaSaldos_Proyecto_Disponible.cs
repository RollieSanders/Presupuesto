...
{
    public partial class Frm_ConsultaSaldos_Proyecto_Disponible : DevExpress.XtraEditors.XtraForm
    {
        

        private SRgestion.WCFgestionEClient objWCF = new SRgestion.WCFgestionEClient();

        public Frm_ConsultaSaldos_Proyecto_Disponible()
        {
            InitializeComponent();
        }
                          ...
                          )
        {
            ...
            {
                DT_Formulacion = objWCF.Lista_Disponible_Proyecto( strAñoProceso,
                                                        strCodProyecto,
                                                        strCodClasificador
                                                     ).Tables[0];
            }
            else
            {
                ...
                DT_Formulacion = SRD.Lista_Disponible_Proyecto(strAñoProceso,
                                                        strCodProyecto,
                                                        strCodClasificador
                                                     ).Tables[0];
            }
