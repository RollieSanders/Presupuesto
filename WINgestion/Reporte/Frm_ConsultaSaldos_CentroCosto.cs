...
{
    public partial class Frm_ConsultaSaldos_CentroCosto : Form
    {
        ...
        private DataSet DS_CentroCosto = new DataSet();
        private DataSet DS_Ejecucion = new DataSet();
        private Boolean blnPintaFormato = true;

        public Frm_ConsultaSaldos_CentroCosto()
        {
            InitializeComponent();
        }
        ...
        private void Btn_Mostrar_Click(object sender, EventArgs e)
        {
            ...
            string strCodCentroCosto_Gestor = Convert.ToString(this.Txt_CodCentroCosto.Value);
            Service.Requerimiento_Detalle SRD = new Service.Requerimiento_Detalle();
            if ( MyStuff.UsaWCF == true  )
            {
                DS_Ejecucion = objWCF.Lista_EjecucionPresupuestal_CentroCosto( strAñoProceso, strCodCentroCosto_Gestor  );
            }
            else
            {
                DS_Ejecucion = SRD.Lista_EjecucionPresupuestal_CentroCosto(strAñoProceso, strCodCentroCosto_Gestor);
            }
        ...
        private void FormatoGrid()
        {
            ...
            oBandPantalla.Columns[0].Header.Caption = "C.Costo";
            oBandPantalla.Columns[0].Width = 100;
            oBandPantalla.Columns[1].Header.Caption = "Centro de Costo";
        ...
        private void Grd_Saldos_ClickCellButton(object sender, CellEventArgs e)
        {
            ...
            string strAñoProceso = Convert.ToString(this.Cbo_AñoProceso.SelectedValue);
            string strCodCentroCosto_Gestor = Convert.ToString(this.Txt_CodCentroCosto.Value); 
            string strCodCentroCosto = Convert.ToString(oRow.Cells[0].Value);
            ...
            if (e.Cell.Column.Index == 4)
            {
                ...
                {
                    WINgestion.Frm_ConsultaSaldos_CentroCosto_Formulado frm = new WINgestion.Frm_ConsultaSaldos_CentroCosto_Formulado();
            ...
            if (e.Cell.Column.Index == 5)
            {
                ...
                {
                    WINgestion.Frm_ConsultaSaldos_CentroCosto_Comprometidos frm = new WINgestion.Frm_ConsultaSaldos_CentroCosto_Comprometidos();
            ...
            if (e.Cell.Column.Index == 6)
            {
                ...
                {
                    WINgestion.Frm_ConsultaSaldos_CentroCosto_Ejecutados frm = new WINgestion.Frm_ConsultaSaldos_CentroCosto_Ejecutados();
            ...
            if (e.Cell.Column.Index == 7)
            {
                ...
                {
                    WINgestion.Frm_ConsultaSaldos_CentroCosto_Disponible frm = new WINgestion.Frm_ConsultaSaldos_CentroCosto_Disponible();
