...
{
    public partial class Frm_ConsultaSaldos_CentroCosto_Disponible : DevExpress.XtraEditors.XtraForm
    {
        

        private SRgestion.WCFgestionEClient objWCF = new SRgestion.WCFgestionEClient();

        public Frm_ConsultaSaldos_CentroCosto_Disponible()
        {
            InitializeComponent();
        }
                          ...
                          )
        {
            ...
            {
                DT_Formulacion = objWCF.Lista_Disponible_CentroCosto( strAñoProceso,
            ...
            else
            {
                ...
                DT_Formulacion = SRD.Lista_Disponible_CentroCosto(strAñoProceso,
                                                        strCodCentroCosto_Gestor,
                                                        strCodCentroCosto,
                                                        strCodClasificador
                                                     ).Tables[0];
        ...
        private void FormatoGrid()
        {
            ...
            oBandPantalla.Columns[13].Header.Caption = "Disponible";
        ...
        private void Frm_ConsultaSaldos_CentroCosto_Disponible_Load(object sender, EventArgs e)
        {
