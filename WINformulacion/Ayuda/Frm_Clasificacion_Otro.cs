...
{
    public partial class Frm_Clasificacion_Otro : DevExpress.XtraEditors.XtraForm
    {
                         ...
                         )
        {
            ...
            {
                DT_Clasificador = objWCF.Ayuda_Clasificador_Otro(strCodCompañia, strCodClaseGasto, strCodCentroCosto).Tables[0];
            }
            else
            {
                DT_Clasificador = SC.Ayuda_Clasificador_Otro(strCodCompañia, strCodClaseGasto, strCodCentroCosto).Tables[0];
            }
