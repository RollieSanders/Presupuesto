...
{
    public partial class Frm_Clasificacion_Tarea : DevExpress.XtraEditors.XtraForm
    {
        ...
        public Frm_Clasificacion_Tarea()
        {
            InitializeComponent();
        }
        ...
        public void Showme(string strCodCompañia, string strCodProyecto, int Fila, string strCodClaseGasto, string strCodCentroCosto )
        {
            ...
            {
                DT_Clasificador = objWCF.Ayuda_Clasificador_tarea(strCodCompañia, strCodProyecto, strCodClaseGasto, strCodCentroCosto).Tables[0];
            }
            else
            {
                DT_Clasificador = SC.Ayuda_Clasificador_tarea(strCodCompañia, strCodProyecto, strCodClaseGasto, strCodCentroCosto).Tables[0];
            }
