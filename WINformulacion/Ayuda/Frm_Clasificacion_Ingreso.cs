...
{
    public partial class Frm_Clasificacion_Ingreso : DevExpress.XtraEditors.XtraForm
    {
        public bool blnEligio = false;
        public string strNomClaseIngreso = "";
        ...
        public Frm_Clasificacion_Ingreso()
        {
            InitializeComponent();
        }
        ...
        public void Showme(string strCodCompañia, string strCodProyecto, int Fila, string strCodClaseIngreso, string strCodCentroCosto )
        {
            ...
            switch (strCodClaseIngreso)
            {
                case "":
                    strCodClaseIngreso = "01/";
                    break;
                case "01":
                    strCodClaseIngreso = "01/";
                    break;
                case "02":
                    strCodClaseIngreso = "02/";
                    break;
            }
            ...
            {
                DT_Clasificador = objWCF.Ayuda_Clasificador_Ingreso(strCodCompañia, strCodCentroCosto).Tables[0];
            }
            else
            {
                DT_Clasificador = SC.Ayuda_Clasificador_Ingreso(strCodCompañia, strCodCentroCosto).Tables[0];
            }
        ...
        private void FormatoGrid()
        {
            ...
            oBandPantalla.Columns[1].Header.Caption = "Clase Ingreso";
        ...
        private void Aceptar()
        {
            ...
            strNomClaseIngreso = Convert.ToString(oRow.Cells[1].Value);
