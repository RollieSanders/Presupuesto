...
{
    public partial class Frm_ActualizaFormulacion_Tarea : Form
    {
        ...
        private string strCelda_TipoGasto_Cabecera = "";
        ...
        public Frm_ActualizaFormulacion_Tarea()
        {
            InitializeComponent();
        }
        ...
        {
            WINformulacion.Movimiento.Frm_ActualizaFormulacion_Tarea_Filtro frm = new WINformulacion.Movimiento.Frm_ActualizaFormulacion_Tarea_Filtro();
            frm.ShowMe();
            if (frm.blnProcesaExcel == true)
            {
                ...
                if (MyStuff.UsaWCF == true)
                {
                    DS_ClaseGasto = objWCF.Combo_ClaseGasto_Tarea("000000",
                                                                   strCodProyecto,
                ...
                else
                {
                    ...
                    DS_ClaseGasto = SDG.Combo_ClaseGasto_Tarea("000000",
                                                                     strCodProyecto,
                                                                       MyStuff.CodigoCentroCosto
                                                                     );
                ...
                //workbook.LoadDocument(@"Excel\Formulacion_Tarea.xlsx", DocumentFormat.Xlsx);


                workbook = spreadsheetControl.Document;
                string sRutaInterna = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, @"Excel\Formulacion_Tarea.xlsx");
                ...
                //worksheet_HojaTrabajo.Cells[3, 4].Value = frm.strNomMacroProyecto;
                worksheet_HojaTrabajo.Cells[3, 2].Value = frm.strNomCentroCosto;



                worksheet_HojaTrabajo.Cells[2, 27].Value = MFC.CañoProceso;
                worksheet_HojaTrabajo.Cells[3, 27].Value = MFC.Cversion;
                worksheet_HojaTrabajo.Cells[4, 27].Value = "Tarea";
                ...
                foreach (DataRow oRow1 in DS_Formulacion.Tables[0].Rows)
                {
                    ...
                    worksheet_HojaTrabajo.Cells[intLinea, 9].Value = Convert.ToString(oRow1["tDescripcionGasto"]);
                    ...
                    worksheet_HojaTrabajo.Cells[intLinea, 28].Value = Convert.ToInt32(oRow1["iidFormulacion_Detalle_Proyecto"]);
                ...
                // Colocar Formulas Fijas

                //worksheet_HojaTrabajo.Cells["X$10:X100"].Formula = "= SUM(L$10:W21 )";
                ...
                //DataValidation validation_worksheet_Importe =
                //    worksheet_HojaTrabajo.DataValidations.Add(worksheet_HojaTrabajo["K10:AA500"],
                //                                                DataValidationType.Custom, "=AND( K10 >= 0)"
                //                                             );


                //validation_worksheet_Importe.ErrorTitle = "Advertencia";
                //validation_worksheet_Importe.ErrorMessage = "Digite un dato númerico";
        ...
        private void ValidarColumnas()
        {
            ...
            //Worksheet worksheet_ClaseGasto = workbook.Worksheets[1];
            //worksheet_ClaseGasto.Visible = false;
            //DV_ClaseGasto = DS_ClaseGasto.Tables[0].DefaultView;
            //worksheet_ClaseGasto.DataBindings.BindToDataSource(DV_ClaseGasto, 1, 0);

            //Range boundrange_ClaseGasto = worksheet_ClaseGasto.DataBindings[0].Range;
            //strCelda_TipoGasto_Cabecera = traeRangoCelda_ClaseGasto(boundrange_ClaseGasto.LeftColumnIndex + 1,
            //                                               boundrange_ClaseGasto.TopRowIndex + 1,
            //                                               boundrange_ClaseGasto.RightColumnIndex + 1,
            //                                               boundrange_ClaseGasto.BottomRowIndex + 1
            //                                );
        ...
        private Boolean ValidaLineaGrabacion(Model.Formulacion_Detalle_Proyecto MFDP, int Linea)
        {
            ...
            //{
            //    pintarError(Linea, 7, true);
            //    blnFilaErrada = true;
            //}
            //else
            //{
            //    pintarError(Linea, 7, false);
            //}
            ...
            if (!string.IsNullOrEmpty(Convert.ToString(worksheet_HojaTrabajo.Cells[Linea, 8].Value.TextValue)))
            {
                ...
                if (Math.Round(Convert.ToDouble(worksheet_HojaTrabajo.Cells[Linea, 27].Value.NumericValue), 2) != 0)
                {
        ...
        private void FormatoCeldas(int intLinea)
        {
            ...
            //string strPorDistribuir = "=" + "K" + strLinea + "-(L" + strLinea + "+Y" + strLinea + "+Z" + strLinea + "+AA" + strLinea + ")";
        ...
        private void Btn_Guardar_Click(object sender, EventArgs e)
        {
            ...
            while (true)
            {
                ...
                MFDP.IidFormulacion_Detalle_Proyecto = Convert.ToInt32(worksheet_HojaTrabajo.Cells[_Rows, 28].Value.NumericValue);
                ...
                MFDP.TdescripcionGasto = Convert.ToString(worksheet_HojaTrabajo.Cells[_Rows, 9].Value.TextValue);
                ...
                if (ValidaLineaGrabacion(MFDP, _Rows) == false)
                {
                    if (MFDP.IidFormulacion_Detalle_Proyecto == 0)
                    {
                        ...
                        worksheet_HojaTrabajo.Cells[_Rows, 28].Value = intIdFormulacion_Detalle_Proyecto;
                    }
                    else
                    {
                        if (MyStuff.UsaWCF == true)
            ...
            if (frm.blnEligio == true)
            {
                ...
                foreach (DataRow oRow in frm.DT_Proyecto.Rows)
                {
                    ...
                    if (Convert.ToBoolean(oRow["bPase"]) == true)
                    {
                        ...
                        int nroOrdenes = DS.Tables[0].Rows.Count;
                        worksheet_HojaTrabajo.Rows.Insert(9 + intNumeroOrdenes, nroOrdenes);
        ...
        private void Btn_EliminarFilas_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    int intIdFormulacion_Detalle_Proyecto = Convert.ToInt32(worksheet_HojaTrabajo.Cells[intLinea, 28].Value.NumericValue);
