...
{
    public partial class Frm_ActualizaFormulacion_Proyecto_Inversion : Form
    {
        ...
        private string strCelda_Componente = "";
        ...
        public Frm_ActualizaFormulacion_Proyecto_Inversion()
        {
            InitializeComponent();
        }
        ...
        {
            WINformulacion.Movimiento.Frm_ActualizaFormulacion_Proyecto_Inversion_Filtro frm = new WINformulacion.Movimiento.Frm_ActualizaFormulacion_Proyecto_Inversion_Filtro();
            frm.ShowMe();
            if (frm.blnProcesaExcel == true)
            {
                ...
                //-- Recuperar Datos
                    ...
                    if (MyStuff.UsaWCF == true)
                    {
                        DS_ClaseGasto = objWCF.Combo_ClaseGasto_Inversion("000000",
                                                                 strCodProyecto,
                    ...
                    {
                        DS_ClaseGasto = SDG.Combo_ClaseGasto_Inversion("000000",
                                                                      strCodProyecto,
                                                                        MyStuff.CodigoCentroCosto
                                                                      );
                    }
                    ...
                    if ( MyStuff.UsaWCF == true )
                    {
                        DS_Componente = objWCF.Ayuda_Proyecto_Componente_Spring("000000", strCodProyecto);
                }
                    else
                    {
                        DS_Componente = SDG.Ayuda_Proyecto_Componente_Spring("000000", strCodProyecto);
                    }

                    if (MyStuff.UsaWCF == true)
                    {
                         DS_FuenteFinanciamiento = objWCF.Combo_Proyecto_FuenteFinanciamiento("000000", strCodProyecto);
                    }
                    else
                    {
                        DS_FuenteFinanciamiento = SDG.Combo_Proyecto_FuenteFinanciamiento("000000", strCodProyecto);
                    }
                    ...
                    if (MyStuff.UsaWCF == true)
                    {
                         DS_Formulacion = objWCF.Lista_FormulacionDetalle_Proyecto("000000", strCodProyecto, strCodCentroCosto, strCodTipoFormulacion);
                    }
                    else
                    {
                        DS_Formulacion = SFDP.Lista_FormulacionDetalle_Proyecto("000000", strCodProyecto, strCodCentroCosto, strCodTipoFormulacion);
                    }

                //DT_Formulacion = DS_Formulacion.Tables[0];
                //DV_Formulacion = DT_Formulacion.DefaultView;
                ...
                //string strValorFiltro = "2";
                //this.DV_Formulacion.RowFilter = "iCodTipoInserccion =" + strValorFiltro;

                //foreach (DataRowView dr_Registro in this.DV_Formulacion)
                //{
                //    if ( !string.IsNullOrEmpty( Convert.ToString(dr_Registro["Orden"]).TrimEnd()) )
                //    {
                //        strListaOrdenes = strListaOrdenes + Convert.ToString(dr_Registro["Orden"]).TrimEnd() + "/";
                //    }
                ...
                string sRutaInterna = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, @"Excel\Formulacion_Proyecto_Inversion.xlsx");
                ...
                worksheet_HojaTrabajo.Cells[3, 2].Value = frm.strNomMacroProyecto;
                worksheet_HojaTrabajo.Cells[4, 2].Value = frm.strNomCentroCosto;



                worksheet_HojaTrabajo.Cells[2, 28].Value = MFC.CañoProceso;
                worksheet_HojaTrabajo.Cells[3, 28].Value = MFC.Cversion;
                worksheet_HojaTrabajo.Cells[4, 28].Value = "Inversión";
                ...
                foreach (DataRow oRow1 in DS_Formulacion.Tables[0].Rows)
                {
                    ...
                    worksheet_HojaTrabajo.Cells[intLinea, 8].Value = Convert.ToString(oRow1["vNomComponente"]);
                    worksheet_HojaTrabajo.Cells[intLinea, 9].Value = Convert.ToString(oRow1["Orden"]);
                    worksheet_HojaTrabajo.Cells[intLinea, 10].Value = Convert.ToString(oRow1["tDescripcionGasto"]);
                    worksheet_HojaTrabajo.Cells[intLinea, 11].Value = Convert.ToDouble(oRow1["fValorAnterior"]);
                    worksheet_HojaTrabajo.Cells[intLinea, 12].Value = Convert.ToDouble(oRow1["fValorRestoActual"]);
                    worksheet_HojaTrabajo.Cells[intLinea, 13].Value = Convert.ToDouble(oRow1["fMes_01"]);
                    worksheet_HojaTrabajo.Cells[intLinea, 14].Value = Convert.ToDouble(oRow1["fMes_02"]);
                    worksheet_HojaTrabajo.Cells[intLinea, 15].Value = Convert.ToDouble(oRow1["fMes_03"]);
                    worksheet_HojaTrabajo.Cells[intLinea, 16].Value = Convert.ToDouble(oRow1["fMes_04"]);
                    worksheet_HojaTrabajo.Cells[intLinea, 17].Value = Convert.ToDouble(oRow1["fMes_05"]);
                    worksheet_HojaTrabajo.Cells[intLinea, 18].Value = Convert.ToDouble(oRow1["fMes_06"]);
                    worksheet_HojaTrabajo.Cells[intLinea, 19].Value = Convert.ToDouble(oRow1["fMes_07"]);
                    worksheet_HojaTrabajo.Cells[intLinea, 20].Value = Convert.ToDouble(oRow1["fMes_08"]);
                    worksheet_HojaTrabajo.Cells[intLinea, 21].Value = Convert.ToDouble(oRow1["fMes_09"]);
                    worksheet_HojaTrabajo.Cells[intLinea, 22].Value = Convert.ToDouble(oRow1["fMes_10"]);
                    worksheet_HojaTrabajo.Cells[intLinea, 23].Value = Convert.ToDouble(oRow1["fMes_11"]);
                    worksheet_HojaTrabajo.Cells[intLinea, 24].Value = Convert.ToDouble(oRow1["fMes_12"]);
                    worksheet_HojaTrabajo.Cells[intLinea, 25].Value = Convert.ToDouble(oRow1["fValorFormulacion"]);
                    worksheet_HojaTrabajo.Cells[intLinea, 26].Value = Convert.ToDouble(oRow1["fValorFormulacionUno"]);
                    worksheet_HojaTrabajo.Cells[intLinea, 27].Value = Convert.ToDouble(oRow1["fValorFormulacionDos"]);
                    worksheet_HojaTrabajo.Cells[intLinea, 28].Value = Convert.ToDouble(oRow1["Distribucion"]);
                    worksheet_HojaTrabajo.Cells[intLinea, 29].Value = Convert.ToInt32(oRow1["iidFormulacion_Detalle_Proyecto"]);
        ...
        private void ValidarColumnas_Orden()
        {
            ...
            DataValidation validation_worksheet_Importe =
                    worksheet_HojaTrabajo.DataValidations.Add(worksheet_HojaTrabajo["L10:AA500"],
                                                                DataValidationType.Custom, "=AND( L10 >= 0, ISNUMBER(L10))"
                                                             );
            ...
            //Worksheet worksheet_ClaseGasto = workbook.Worksheets[1];
            //worksheet_HojaTrabajo.DataValidations.Add(worksheet_HojaTrabajo["C10:C500"], DataValidationType.List, ValueObject.FromRange(worksheet_ClaseGasto[strCelda_TipoGasto_Cabecera].GetRangeWithAbsoluteReference()));
            ...
            Worksheet worksheet_Componente = workbook.Worksheets[3];
            worksheet_HojaTrabajo.DataValidations.Add(worksheet_HojaTrabajo["I10:I500"], DataValidationType.List, ValueObject.FromRange(worksheet_Componente[strCelda_Componente].GetRangeWithAbsoluteReference()));
        ...
        private void ValidarColumnas()
        {
            Worksheet worksheet_HojaTrabajo = workbook.Worksheets[0];
            DataValidation validation_worksheet_Importe =
                    worksheet_HojaTrabajo.DataValidations.Add(worksheet_HojaTrabajo["L10:AB500"],
                                                                DataValidationType.Custom, "=AND( L10 >= 0, ISNUMBER(L10))"
                                                             );
            ...
            Range boundrange_Componente = worksheet_Componente.DataBindings[0].Range;
            strCelda_Componente = traeRangoCelda_Componente(boundrange_Componente.LeftColumnIndex + 1,
                                                           boundrange_Componente.TopRowIndex + 1,
                                                           boundrange_Componente.RightColumnIndex + 1,
                                                           boundrange_Componente.BottomRowIndex + 1
                                            );
            ...
            while (true)
            {
                ...
                if (!string.IsNullOrEmpty(Convert.ToString(worksheet_HojaTrabajo.Cells[intLinea, 9].Value.TextValue)))
                {
                    strOrdenes = strOrdenes + 
                                 ...
                                 Convert.ToString(worksheet_HojaTrabajo.Cells[intLinea, 9].Value.TextValue).TrimEnd() + "/";
        ...
        private string traeRangoCelda_Componente(int y1, int x1, int y2, int x2)
        {
            string strCelda = "";
            char columna1;
            string fila1;
        ...
        private Boolean ValidaLineaGrabacion(Model.Formulacion_Detalle_Proyecto MFDP, int Linea)
        {
            ...
            {
                pintarError(Linea, "K", true);
                blnFilaErrada = true;
            }
            else
            {
                pintarError(Linea, "K", false);
            }

            if (!string.IsNullOrEmpty(Convert.ToString(worksheet_HojaTrabajo.Cells[Linea, 9].Value.TextValue)))
            {
                if (Math.Round(  Convert.ToDouble(  worksheet_HojaTrabajo.Cells[Linea, 28].Value.NumericValue ), 2 ) != 0 )
                {
                    pintarError(Linea, "AC", true);
                    blnFilaErrada = true;
                }
                else
                {
                    pintarError(Linea, "AC", false);
                }
            }
            else
            {
        ...
        {
            //string Rango = traeRangoCelda(14, intLinea + 1, 25, intLinea + 1);
            workbook = spreadsheetControl.Document;
            Worksheet worksheet_HojaTrabajo = workbook.Worksheets[0];
            ...
            string strSuma_2020 = "=SUM(" + "N" + strLinea + ":Y" + strLinea + ")";
            string strPorDistribuir = "=" + "SI(L" + strLinea + "=0;0;" + "L" + strLinea + "-(M" + strLinea + "+Z" + strLinea + "+AA" + strLinea + "+AB" + strLinea + "))";

            //SI(K10 = 0; 0; K10 - (L10 + Y10 + Z10 + AA10) )

            worksheet_HojaTrabajo.Cells[intLinea, 25].Formula = strSuma_2020;
            worksheet_HojaTrabajo.Cells[intLinea, 28].Formula = strPorDistribuir;
        ...
        private void Btn_BuscaClasificador_Click(object sender, EventArgs e)
        {
            ...
            {
                string strNomClaseGasto = Convert.ToString(worksheet_HojaTrabajo.Cells[intLinea, 1].Value.TextValue); ;
                ...
                WINformulacion.Frm_Clasificacion frm = new WINformulacion.Frm_Clasificacion();
                ...
                if (frm.blnEligio == true)
                {
                    ...
                    worksheet_HojaTrabajo.Cells[intLinea, 11].Value = 0;
        ...
        private void Btn_Guardar_Click(object sender, EventArgs e)
        {
            ...
            while (true)
            {
                ...
                MFDP.IidFormulacion_Detalle_Proyecto = Convert.ToInt32(worksheet_HojaTrabajo.Cells[_Rows, 29].Value.NumericValue);
                ...
                //MFDP.VnomComponente = Convert.ToString(worksheet_HojaTrabajo.Cells[_Rows, 8].Value.TextValue);
                ...
                if (string.IsNullOrEmpty(Convert.ToString(worksheet_HojaTrabajo.Cells[_Rows, 9].Value.TextValue)))
                {
                    MFDP.CTipoOrden = "";
                    MFDP.CNumeroOrden = "";
                }
                ...
                {
                    MFDP.CTipoOrden = Convert.ToString(worksheet_HojaTrabajo.Cells[_Rows, 9].Value.TextValue).Substring(0, 2);
                    MFDP.CNumeroOrden = Convert.ToString(worksheet_HojaTrabajo.Cells[_Rows, 9].Value.TextValue).Substring(3, 10);
                }
                ...
                MFDP.TdescripcionGasto = Convert.ToString(worksheet_HojaTrabajo.Cells[_Rows, 10].Value.TextValue);
                MFDP.FvalorAnterior = Convert.ToDouble(worksheet_HojaTrabajo.Cells[_Rows, 11].Value.NumericValue);
                MFDP.FvalorRestoActual = Convert.ToDouble(worksheet_HojaTrabajo.Cells[_Rows, 12].Value.NumericValue);
                MFDP.FvalorFormulacion = Convert.ToDouble(worksheet_HojaTrabajo.Cells[_Rows, 25].Value.NumericValue);
                MFDP.FvalorFormulacionUno = Convert.ToDouble(worksheet_HojaTrabajo.Cells[_Rows, 26].Value.NumericValue);
                MFDP.FvalorFormulacionDos = Convert.ToDouble(worksheet_HojaTrabajo.Cells[_Rows, 27].Value.NumericValue);
                ...
                MFDP.Fmes_01 = Convert.ToDouble(worksheet_HojaTrabajo.Cells[_Rows, 13].Value.NumericValue);
                MFDP.Fmes_02 = Convert.ToDouble(worksheet_HojaTrabajo.Cells[_Rows, 14].Value.NumericValue);
                MFDP.Fmes_03 = Convert.ToDouble(worksheet_HojaTrabajo.Cells[_Rows, 15].Value.NumericValue);
                MFDP.Fmes_04 = Convert.ToDouble(worksheet_HojaTrabajo.Cells[_Rows, 16].Value.NumericValue);
                MFDP.Fmes_05 = Convert.ToDouble(worksheet_HojaTrabajo.Cells[_Rows, 17].Value.NumericValue);
                MFDP.Fmes_06 = Convert.ToDouble(worksheet_HojaTrabajo.Cells[_Rows, 18].Value.NumericValue);
                MFDP.Fmes_07 = Convert.ToDouble(worksheet_HojaTrabajo.Cells[_Rows, 19].Value.NumericValue);
                MFDP.Fmes_08 = Convert.ToDouble(worksheet_HojaTrabajo.Cells[_Rows, 20].Value.NumericValue);
                MFDP.Fmes_09 = Convert.ToDouble(worksheet_HojaTrabajo.Cells[_Rows, 21].Value.NumericValue);
                MFDP.Fmes_10 = Convert.ToDouble(worksheet_HojaTrabajo.Cells[_Rows, 22].Value.NumericValue);
                MFDP.Fmes_11 = Convert.ToDouble(worksheet_HojaTrabajo.Cells[_Rows, 23].Value.NumericValue);
                MFDP.Fmes_12 = Convert.ToDouble(worksheet_HojaTrabajo.Cells[_Rows, 24].Value.NumericValue);
                ...
                if (ValidaLineaGrabacion(MFDP, _Rows) == false)
                {
                    if (MFDP.IidFormulacion_Detalle_Proyecto == 0)
                    {
                        ...
                        worksheet_HojaTrabajo.Cells[_Rows, 29].Value = intIdFormulacion_Detalle_Proyecto;
                    }
                    else
                    {
                        if (MyStuff.UsaWCF == true)
        ...
        private void Btn_DistribuyeLineaFormulada_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                    ...
                    {
                        worksheet_HojaTrabajo.Cells[intLinea, 11].Value = frm.dblSaldoAnteior;
                        worksheet_HojaTrabajo.Cells[intLinea, 12].Value = frm.dblImporte_2019;
                        worksheet_HojaTrabajo.Cells[intLinea, 25].Value = frm.dblImporte_2020;
                        worksheet_HojaTrabajo.Cells[intLinea, 26].Value = frm.dblImporte_2021;
                        worksheet_HojaTrabajo.Cells[intLinea, 27].Value = frm.dblImporte_2022;
                        worksheet_HojaTrabajo.Cells[intLinea, 13].Value = frm.dblEnero;
                        worksheet_HojaTrabajo.Cells[intLinea, 14].Value = frm.dblFebrero;
                        worksheet_HojaTrabajo.Cells[intLinea, 15].Value = frm.dblMarzo;
                        worksheet_HojaTrabajo.Cells[intLinea, 16].Value = frm.dblAbril;
                        worksheet_HojaTrabajo.Cells[intLinea, 17].Value = frm.dblMayo;
                        worksheet_HojaTrabajo.Cells[intLinea, 18].Value = frm.dblJunio;
                        worksheet_HojaTrabajo.Cells[intLinea, 19].Value = frm.dblJulio;
                        worksheet_HojaTrabajo.Cells[intLinea, 20].Value = frm.dblAgosto;
                        worksheet_HojaTrabajo.Cells[intLinea, 21].Value = frm.dblSetiembre;
                        worksheet_HojaTrabajo.Cells[intLinea, 22].Value = frm.dblOctubre;
                        worksheet_HojaTrabajo.Cells[intLinea, 23].Value = frm.dblNoviembre;
                        worksheet_HojaTrabajo.Cells[intLinea, 24].Value = frm.dblDiciembre;
                        worksheet_HojaTrabajo.Cells[intLinea, 25].Value = frm.dblTotalDistribucion;
                        this.FormatoCeldas(intLinea);
                    }
            }
        }
        ...
        private void Btn_MostarOrdenesPendientes_Click(object sender, EventArgs e)
        {
            ...
            if (frm.blnEligio == true)
            {
                ...
                foreach (DataRow oRow in frm.DT_Proyecto.Rows)
                {
                    ...
                    {
                        //string strCodProyecto_Detalle = Convert.ToString(oRow["Proyecto"]);
                        ...
                        foreach (DataRow oRow1 in DS.Tables[0].Rows)
                        {
                            ...
                            worksheet_HojaTrabajo.Cells[intLinea, 9].Value = strTipoOrden.TrimEnd() + "-" + strNumeroOrden;
                            worksheet_HojaTrabajo.Cells[intLinea, 10].Value = Convert.ToString(oRow1["ObjetoContratacion"]);
                            worksheet_HojaTrabajo.Cells[intLinea, 11].Value = Math.Round(  Convert.ToDouble(oRow1["Saldo"]), 2 );
                            worksheet_HojaTrabajo.Cells[intLinea, 29].Value = 0;
        ...
        private void spreadsheetControl_CellValueChanged(object sender, DevExpress.XtraSpreadsheet.SpreadsheetCellEventArgs e)
        {
            ...
            //        string datoCopy = "";
            //        if ( !string.IsNullOrEmpty(  Convert.ToString(  worksheet_HojaTrabajo.Cells[e.RowIndex, 1000].Value.TextValue  ) ) )
            //        {
            //            datoCopy = Convert.ToString(worksheet_HojaTrabajo.Cells[e.RowIndex, 1000].Value.TextValue) ;
            //        }

            //        if (Convert.ToString(e.Value.TextValue ) != datoCopy )
            //        {
            //            MessageBox.Show("El número de la orden es generada desde Saldos Años Anteriores");
            //            worksheet_HojaTrabajo.Cells[e.RowIndex, e.ColumnIndex].Value = Convert.ToString(worksheet_HojaTrabajo.Cells[e.RowIndex, 1000].Value.TextValue); ;
            //        }
            //        break;
            //}
            ...
            //if ( string.IsNullOrEmpty(Convert.ToString(worksheet_HojaTrabajo.Cells[intLinea, 1].Value.TextValue)) )
            //{
            //    MessageBox.Show("Este dato debe estar en blanco");
            //    worksheet_HojaTrabajo.Cells[intLinea, 8].Value = "        ";
            //}
            //else
            //{
            //    if (Convert.ToString(worksheet_HojaTrabajo.Cells[intLinea, 1].Value.TextValue).TrimEnd() == "Año Anterior")
            //    {
            //        worksheet_HojaTrabajo.Cells[intLinea, 8].Value = Convert.ToString(worksheet_HojaTrabajo.Cells[intLinea, 1000].Value.TextValue);
            //    }
            //    else
            //    {
            //        MessageBox.Show("Este dato debe estar en blanco");
        ...
        private void spreadsheetControl_CellBeginEdit(object sender, DevExpress.XtraSpreadsheet.SpreadsheetCellCancelEventArgs e)
        {
            ...
            if (e.ColumnIndex == 9 && e.RowIndex >= 9)
                e.Cancel = true;

            if (e.ColumnIndex == 11 && e.RowIndex >= 9)
                e.Cancel = true;

            if (e.ColumnIndex == 25 && e.RowIndex >= 9)
                e.Cancel = true;

            if (e.ColumnIndex == 28 && e.RowIndex >= 9)
                e.Cancel = true;
        }
        ...
        private void Btn_EliminarFilas_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    int intIdFormulacion_Detalle_Proyecto = Convert.ToInt32(worksheet_HojaTrabajo.Cells[intLinea, 29].Value.NumericValue);
        ...
        private void spreadsheetControl_RangeCopied(object sender, RangeCopiedEventArgs e)
        {
            //int a = 1;
            //MessageBox.Show("1");
        }
        ...
        private void Mnu_Ayuda_Click(object sender, EventArgs e)
        {
            
        }

        private void spreadsheetControl_CopiedRangePasted(object sender, CopiedRangePastedEventArgs e)
        {
        ...
        private void spreadsheetControl_CopiedRangePasting(object sender, CopiedRangePastingEventArgs e)
        {
            //int a = 1;
            //MessageBox.Show("4");
        }
        ...
        private void EliminarFilas(List<int> elementos)
        {
            ...
            int intNumeroElementos = elementos.Count;
                ...
                {
                    intIdFormulacion_Detalle_Proyecto = Convert.ToInt32(worksheet_HojaTrabajo.Cells[elementos[i] - 1, 29].Value.NumericValue);
                    if (intIdFormulacion_Detalle_Proyecto > 0)
                    {
                        Boolean blnResult = false;
                        if (MyStuff.UsaWCF == true)
        ...
        private void Btn_Imprimir_Click(object sender, EventArgs e)
        {
            workbook = spreadsheetControl.Document;
            Worksheet worksheet_HojaTrabajo = workbook.Worksheets[0];
            string strNomProyecto = Convert.ToString(worksheet_HojaTrabajo.Cells[2, 2].Value);
            string strNomCentroCosto = Convert.ToString(worksheet_HojaTrabajo.Cells[4, 2].Value);

            WINformulacion.Frm_Reporte_Formulacion_Proyecto_CentroGestor frm = new WINformulacion.Frm_Reporte_Formulacion_Proyecto_CentroGestor();
            frm.ShowMe(strCodTipoFormulacion,
                       "Inversion",
                        strCodProyecto,
                        strNomProyecto,
                        strCodCentroCosto,
